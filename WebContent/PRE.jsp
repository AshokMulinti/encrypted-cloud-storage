...
<body>
	...
	<div class="container ">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<h2>
					<span>PRE - PROXY RE-ENCRYPTION</span>
				</h2>
				<br>
					...
					<table id="myTable" class="table table-bordred table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td><%=rs.getString("Reencrypt")%></td>

								<td><a
									href="PREHandle.jsp?Encrypt=<%=rs.getString("encrypt")%>&ffilename=<%=rs.getString("filename")%>"
									class="btn btn-danger btn-sm">RE-Encrypt</a></td>
	...
	<script>
		...
		if(test=${param.success==1}){
			console.log("success");
			swal("RE-ENCRYPT!", "DATA HAS BEEN RE-ENCRYPTED!", "success");
